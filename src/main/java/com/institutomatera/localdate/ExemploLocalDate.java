package com.institutomatera.localdate;
...
public class ExemploLocalDate {
    public static void main(String[] args) {
        ...
        System.out.println("Ano bissexto: " + outraData.isLeapYear());
        System.out.println("Total de dias do mês: " + outraData.lengthOfMonth());
    }
}
